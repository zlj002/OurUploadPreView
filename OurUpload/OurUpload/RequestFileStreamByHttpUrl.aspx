<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestFileStreamByHttpUrl.aspx.cs"
            ...
            <div class="span12">
                <ul class="inline">
                    <li style="cursor: pointer; width: 50px;">
                        ...
                        下载 </asp:HyperLink></li>
                    <li style="cursor: pointer; width: 50px;"><a onclick='window.frames["win"].contentWindow==null?window.frames["win"].window.print():window.frames["win"].contentWindow.print()'>
